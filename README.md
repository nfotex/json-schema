This is json-schema, a C++ library for validating JSON documents against [JSON Schemata](https://json-schema.org) based on [jsoncpp](https://github.com/open-source-parsers/jsoncpp). It implements draft-07.
